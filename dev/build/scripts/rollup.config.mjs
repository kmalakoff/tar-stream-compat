...
const replacements = {};
replacements['USTAR_MAGIC.compare('] = 'BufferCompare(USTAR_MAGIC, ';
replacements['GNU_MAGIC.compare('] = 'BufferCompare(GNU_MAGIC, ';
replacements['GNU_VER.compare('] = 'BufferCompare(GNU_VER, ';
replacements['Math.trunc('] = 'MathTrunc(';
